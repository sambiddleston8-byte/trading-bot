...
- The replay input-coverage contract now maps all 22 sealed engine keys to their
  dependency kinds and, for artifact-backed engines, their authenticated
  point-in-time roles. An engine may combine kinds: outcome learning is
