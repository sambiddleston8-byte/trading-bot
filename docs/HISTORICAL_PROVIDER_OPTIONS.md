...
| Free EODHD account | Account and secret-safe adapter are configured. Official documentation describes S&P 500 historical components, delisted price history, adjusted data, splits and dividends. | The live probe returned HTTP 401 for S&P history and rejected the delisted sample response. EODHD's separately published S&P/Dow historical-constituents product does not include Nasdaq-100. Symbol lineage, complete terminal outcomes and corrections/revisions remain unproven. | Do not purchase for the combined-universe replay. It cannot solve the full mandate alone. |
